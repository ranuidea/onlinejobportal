...
<script type="text/javascript">
	 	$(document).ready(function() {
	 		var val = "<c:out value="${jobRequirement.jobType}"/>";
			 $("#jobType option[value='"+val+"']").attr("selected","selected");
		});
	</script>
<style>
.navbar-custom {
			...
			<div class="row">
					...
					<div class="col-xs-12">
						<div class="form-wrap">
							...
							<form role="form"
					action="<c:url value='/company/editJobRequirement' />"
					method="post" id="login-form" autocomplete="off">
							<input type="hidden" id="jobId" name="jobId" value="${jobRequirement.jobId}">
							<div class="form-group">
								<label for="email" class="sr-only">Mobile No</label> <input
									type="text" name="jobTitle" id="jobTitle"
									class="form-control" placeholder="Job Title" value="${jobRequirement.jobTitle}"
									required>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label for="email" class="sr-only">Mobile No</label> <input
									...
									class="form-control" placeholder="Required Skill" value="${jobRequirement.requiredSkill}"
									required>
							</div>
							
							<div class="form-group">
								<label for="email" class="sr-only">Mobile No</label>
								<textarea class="form-control" rows="5" name="jobDescription" id="jobDescription" placeholder="Job Description" value="" required>${jobRequirement.jobDescription}</textarea>
							</div>
							<input type="submit" id="btn-login"
								class="btn btn-custom btn-lg btn-block" value="Edit">
							</form>
						</div>
					</div>
					<!-- /.col-xs-12 -->
